...
namespace ZYSoft.SQLDAL
{
    public class SqlHelper : IDisposable
    {
        ...
        public SqlHelper()
        {
            _cnnSql = new SqlConnection(ConnectionString != string.Empty ? ConnectionString : ConfigurationManager.ConnectionStrings["RisConnString"].ConnectionString);
        }
