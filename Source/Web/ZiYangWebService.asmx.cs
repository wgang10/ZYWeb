...
namespace Web
{
    ...
    {   
        ...
        public ReturnValue GetStatisticsData(string StatisticsType,string YearMonth,string gender)
        {
            return new ReturnValue();
        }

        [WebMethod(Description = "导入生化数据")]
        public ReturnValue InportBiochemistryData(List<Biochemistry> list)
        {
            return new ReturnValue();
        }
    }
